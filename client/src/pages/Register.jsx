    ...
    return (
        <div className='flex justify-center items-center max-w[500px] h-[90vh] '>
            <div className="shadow-2xl p-10">
                <div className="text-3xl text-primaryGreen font-bold text-center mb-5">Register</div>
                <form className='flex flex-col gap-5' onSubmit={handleRegister}>
                    <input type="text" placeholder='Name' name="name" value={user.name} className='px-5 py-2 rounded-lg border-2 border-primaryGreen outline-none' onChange={handleChange} />
                ...
                <Link to='/login' className="text-primaryGreen underline">Customer Already? Login</Link>
                <ToastContainer
